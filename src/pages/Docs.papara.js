        ...
        <div className="col-span-12 lg:col-span-9">
          <Container>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="px-4 py-2">
                        The firm key is your firm key to authorize transactions.
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-2">
                        ...
                        website in order to indetifying transactions of your
                        users
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-2">
                        https://yourwebsite.com/transaction
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="px-4 py-2">string</td>
                      <td className="px-4 py-2">
                        If you have transaction id on your system you can add it
              ...
              <div className="bg-secondary p-5 rounded-md ">
                <div className="nav flex justify-between text-white">
                  <h1>
                    ...
                    <span className="text primary ml-5">
                      https://pr-pays.com/api/entegration/transaction?transactionUid=transactionUid
                    </span>
                  </h1>
                </div>
              </div>
                ...
                <pre>
                  {language === "javascript" && (
                    <code className="text-white">
                      {`
                            ...
                            const url = "https://pr-pays.com/api/entegration/transaction?transactionUid=", transactionUid;
                  ...
                  {language === "python" && (
                    <code className="text-white">
                      ...
                      url = f"https://pr-pays.com/api/entegration/transaction?transactionUid={transactionUid}"
                  ...
                  {language === "php" && (
                    <code className="text-white">
                      ...
                      $url = 'https://pr-pays.com/api/entegration/transaction?transactionUid=' . urlencode($transactionUid);
            ...
            <div id="bank-withdraw">
              <h1 className="font-bold mt-5 mb-1">Papara Withdraw:</h1>
              <div className="bg-secondary p-5 rounded-md ">
                <div className="nav flex justify-between text-white">
                  <h1>
                    <span className="bg-primary p-5 rounded-md ml-[-20px]">
                    ...
                    <span className="text primary ml-5">
                      https://pr-pays.com/api/transactions/makewithdrawrequest
                    </span>
                  </h1>
                </div>
              </div>
                ...
                <pre>
                    ...
                    <code className="text-white">
                      ...
                      const postData = {
                          ...
                          bankAccount: {
                            ...
                            'hash': '4d78c4c6b9bb5a191db8cd9bdf23292405e9f9c11a8354789decebc36e92bc5d' // SHA256 (firm_key + "pr-pays.com")
                          },
                          ipadress: '127.0.0.1',
                      ...
                      const url = 'https://pr-pays.com/api/transactions/makewithdrawrequest';
                  ...
                  {language === "python" && (
                    <code className="text-white">
                      ...
                      url = 'https://pr-pays.com/api/transactions/makewithdrawrequest'
            ...
            <div id="bank-deposit">
              <h1 className="font-bold mt-5 mb-1">Papara Deposit:</h1>
              <div className="bg-secondary p-5 rounded-md ">
                <div className="nav flex justify-between text-white">
                  <h1>
                    <span className="bg-primary p-5 rounded-md ml-[-20px]">
                    ...
                    <span className="text primary ml-5">
                      https://pr-pays.com/api/entegration/createdeposit
                    </span>
                  </h1>
                </div>
              </div>
                ...
                <pre>
                  {language === "javascript" && (
                    <code className="text-white">
                      ...
                      const url = 'https://pr-pays.com/api/entegration/createdeposit';
                  ...
                  {language === "python" && (
                    <code className="text-white">
                      ...
                      url = 'https://pr-pays.com/api/entegration/createdeposit'
